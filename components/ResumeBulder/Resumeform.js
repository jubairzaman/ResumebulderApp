                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 px-5 py-5">
                        <div>
                            <label class="block">
                                ...
                                <input type="text" name="Title" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Engineer" />
                            </label>
                        </div>
                        <div>
    ...
    "/>
                        ...
                        <div>
                            <label class="block">
                                ...
                                <input onChange={(e) => handelCvData(e.target['value'], 'firstName')} type="text" name="Firstname" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="" />
                            </label>
                        </div>
                        <div><label class="block">
                            ...
                            <input onChange={(e) => handelCvData(e.target['value'], 'lastName')} type="text" name="lastName" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="" />
                        </label></div>
                        <div>
                            <label class="block">
                                <span class="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-slate-700">
