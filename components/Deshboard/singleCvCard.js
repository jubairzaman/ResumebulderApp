        ...
        <div>
            ...
            <div className="grid grid-cols-2 gap-2">
                ...
                <div className="grid grid-rows-6 grid-flow-col ">
                    ...
                    <a> <i className="lar la-copy la-1x text-indigo-500"></i> <span className='ms-2 hover:text-indigo-500'>Duplicate</span>  </a>
                    <a> <i className="lar la-trash-alt la-1x text-indigo-500"></i> <span className='ms-2 hover:text-indigo-500'>Delete</span>  </a>
