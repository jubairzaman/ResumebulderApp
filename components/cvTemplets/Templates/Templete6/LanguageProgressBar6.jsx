...
const LanguageProgressBar6 = ({ languageName, value }) => {
    ...
    return (
        <>
            ...
            <View style={{ width:"100%", display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center",marginLeft:"5px", alignContent: "center",marginTop:"7px"}}>
                ...
                <View style={{ ...Styles.col8 }}>
                    <View style={{ height: "3px", width: "50%", marginTop: "4px", marginLeft: "8px" }}>
